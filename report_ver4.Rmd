...
```{r, message=FALSE, warning=FALSE}  
  ...
  if (raw()@annotation!='pd.mogene.1.0.st.v1' && raw()@annotation!='pd.mogene.1.1.st.v1') {
...
```{r}
  ...
  #The code below excludes clariom chips from probeset calls 
   ...
   if (raw()@annotation=="pd.clariom.s.human.ht" | raw()@annotation=="pd.clariom.s.mouse.ht" | raw()@annotation=="pd.clariom.s.mouse" | raw()@annotation=="pd.clariom.s.human" | raw()@annotation=='pd.hg.u219' | raw()@annotation=='pd.hta.2.0') {
  }
  
  if (raw()@annotation=="pd.hg.u133.plus.2" | raw()@annotation=='pd.mouse430.2' | raw()@annotation=='pd.hg.u133a' | raw()@annotation=='pd.hg.u133a.2' | raw()@annotation=='pd.mg.u74av2' | raw()@annotation=='pd.mouse430a.2' | raw()@annotation=='pd.moe430a' | raw()@annotation=='pd.hg.u95av2' | raw()@annotation=='pd.hg.u133b') {  
      ...
      axis(1,at=c(1:PApsetNC),labels=names(pres),las=2,cex.lab=0.4)
        ...
        if (raw()@annotation=="pd.mogene.2.0.st" | raw()@annotation=="pd.hugene.2.0.st" | raw()@annotation=='pd.hugene.1.0.st.v1' | raw()@annotation=='pd.mogene.1.0.st.v1' | raw()@annotation=='pd.huex.1.0.st.v2' | raw()@annotation=='pd.moex.1.0.st.v1' | raw()@annotation=='pd.hugene.1.1.st.v1' | raw()@annotation=='pd.mogene.1.1.st.v1') {
